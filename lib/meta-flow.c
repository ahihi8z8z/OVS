             ...
             const union mf_value *value, struct match *match, char **err_str)
{
    ...
    /*Hai mod*/
    case MFF_IP_TUN_OPT:
        match_set_tun_opt(match, value->be32);
        break;
...
mf_set_wild(const struct mf_field *mf, struct match *match, char **err_str)
{
    ...
    /*Hai mod*/
    case MFF_IP_TUN_OPT:
        match->wc.masks.tun_opt = 0;
        match->flow.tun_opt = 0;
        break;
